...
template<typename T> struct VariableDescUnionTraits {
  static const VariableDesc enum_value = VariableDesc_NONE;
};

template<> struct VariableDescUnionTraits<paddle::lite::fbs::proto::ParamDesc_::DenseTensorDescT> {
  static const VariableDesc enum_value = VariableDesc_DenseTensorDesc;
};
...
struct VariableDescUnion {
  ...
  void Set(T&& val) {
    ...
    Reset();
    type = VariableDescUnionTraits<RT>::enum_value;
...
struct CombinedParamsDescT : public ::flatbuffers::NativeTable {
  ...
  CombinedParamsDescT() = default;
  CombinedParamsDescT(const CombinedParamsDescT &o);
  CombinedParamsDescT(CombinedParamsDescT&&) FLATBUFFERS_NOEXCEPT = default;
  CombinedParamsDescT &operator=(CombinedParamsDescT o) FLATBUFFERS_NOEXCEPT;
};
...
struct VersionDesc FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  bool mutate_model_version(int32_t _model_version = 0) {
...
struct ParamDescT : public ::flatbuffers::NativeTable {
  ...
  ParamDescT() = default;
  ParamDescT(const ParamDescT &o);
  ParamDescT(ParamDescT&&) FLATBUFFERS_NOEXCEPT = default;
  ParamDescT &operator=(ParamDescT o) FLATBUFFERS_NOEXCEPT;
};
...
struct ParamDesc FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  bool KeyCompareLessThan(const ParamDesc * const o) const {
    return *name() < *o->name();
  }
  ...
  bool Verify(::flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           ...
           VerifyField<uint8_t>(verifier, VT_VARIABLE_TYPE, 1) &&
...
inline bool operator==(const CombinedParamsDescT &lhs, const CombinedParamsDescT &rhs) {
  return
      (lhs.params.size() == rhs.params.size() && std::equal(lhs.params.cbegin(), lhs.params.cend(), rhs.params.cbegin(), [](std::unique_ptr<paddle::lite::fbs::proto::ParamDescT> const &a, std::unique_ptr<paddle::lite::fbs::proto::ParamDescT> const &b) { return (a == b) || (a && b && *a == *b); }));
}
...
inline CombinedParamsDescT::CombinedParamsDescT(const CombinedParamsDescT &o) {
  params.reserve(o.params.size());
  for (const auto &params_ : o.params) { params.emplace_back((params_) ? new paddle::lite::fbs::proto::ParamDescT(*params_) : nullptr); }
}

inline CombinedParamsDescT &CombinedParamsDescT::operator=(CombinedParamsDescT o) FLATBUFFERS_NOEXCEPT {
...
inline CombinedParamsDescT *CombinedParamsDesc::UnPack(const ::flatbuffers::resolver_function_t *_resolver) const {
  auto _o = std::unique_ptr<CombinedParamsDescT>(new CombinedParamsDescT());
...
inline void CombinedParamsDesc::UnPackTo(CombinedParamsDescT *_o, const ::flatbuffers::resolver_function_t *_resolver) const {
  (void)_o;
  (void)_resolver;
  { auto _e = params(); if (_e) { _o->params.resize(_e->size()); for (::flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) { if(_o->params[_i]) { _e->Get(_i)->UnPackTo(_o->params[_i].get(), _resolver); } else { _o->params[_i] = std::unique_ptr<paddle::lite::fbs::proto::ParamDescT>(_e->Get(_i)->UnPack(_resolver)); } } } else { _o->params.resize(0); } }
}
...
inline void DenseTensorDesc::UnPackTo(DenseTensorDescT *_o, const ::flatbuffers::resolver_function_t *_resolver) const {
  ...
  { auto _e = lod(); if (_e) { _o->lod.resize(_e->size()); for (::flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) { _o->lod[_i] = _e->Get(_i); } } else { _o->lod.resize(0); } }
  { auto _e = dim(); if (_e) { _o->dim.resize(_e->size()); for (::flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) { _o->dim[_i] = _e->Get(_i); } } else { _o->dim.resize(0); } }
...
inline VersionDescT *VersionDesc::UnPack(const ::flatbuffers::resolver_function_t *_resolver) const {
  auto _o = std::unique_ptr<VersionDescT>(new VersionDescT());
  UnPackTo(_o.get(), _resolver);
  return _o.release();
}
...
inline ParamDescT::ParamDescT(const ParamDescT &o)
      : version((o.version) ? new paddle::lite::fbs::proto::ParamDesc_::VersionDescT(*o.version) : nullptr),
        name(o.name),
        variable(o.variable) {
}

inline ParamDescT &ParamDescT::operator=(ParamDescT o) FLATBUFFERS_NOEXCEPT {
...
inline ParamDescT *ParamDesc::UnPack(const ::flatbuffers::resolver_function_t *_resolver) const {
  auto _o = std::unique_ptr<ParamDescT>(new ParamDescT());
  UnPackTo(_o.get(), _resolver);
  return _o.release();
}
...
inline void ParamDesc::UnPackTo(ParamDescT *_o, const ::flatbuffers::resolver_function_t *_resolver) const {
  (void)_o;
  (void)_resolver;
  { auto _e = version(); if (_e) { if(_o->version) { _e->UnPackTo(_o->version.get(), _resolver); } else { _o->version = std::unique_ptr<paddle::lite::fbs::proto::ParamDesc_::VersionDescT>(_e->UnPack(_resolver)); } } else if (_o->version) { _o->version.reset(); } }
...
inline paddle::lite::fbs::proto::CombinedParamsDesc *GetMutableSizePrefixedCombinedParamsDesc(void *buf) {
  return ::flatbuffers::GetMutableSizePrefixedRoot<paddle::lite::fbs::proto::CombinedParamsDesc>(buf);
}
